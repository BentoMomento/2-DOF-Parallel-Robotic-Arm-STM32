...
#define BOUNDARY1_Pin GPIO_PIN_4
#define BOUNDARY1_GPIO_Port GPIOA
#define BOUNDARY2_Pin GPIO_PIN_5
#define BOUNDARY2_GPIO_Port GPIOA
#define DS_Pin GPIO_PIN_7
#define DS_GPIO_Port GPIOA
#define STCP_Pin GPIO_PIN_11
